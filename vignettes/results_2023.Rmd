...
vignette: >
  %\VignetteIndexEntry{Results 2023}
...
is_kwb <- stringr::str_extract(men_bwb$team, pattern = "[1-9][1-9]?[0-9]?") %in% 115:116
...
```{r women}
women <- teamstaffel::get_results("W", year = 2023, event = "ALL")
DT::datatable(women)
